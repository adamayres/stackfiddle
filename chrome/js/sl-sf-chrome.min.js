 ...
 * Mon Jan  2 23:51:05 PST 2012
 */
var StackFiddle=function(){var b,c={stackUrl:"",scripts:[],onMouseoverCode:function(){},onMouseoutCode:function(){},openDialog:function(){},closeDialog:function(){},applyEventListenersOnOpen:!1};isInit=!1;var d=function(a){var b="http://ajax.googleapis.com/ajax/libs/jquery/1.5.1/jquery.min.js",d=0,e=function(){d<c.scripts.length?ScriptLoader.addJs(c.scripts[d++],e):a()};!window.hasOwnProperty("jQuery")||!ScriptLoader.isVersionLoaded(window.jQuery.fn.jquery,"1.4.4")?ScriptLoader.addJs(b,e):e()},e=function(e){if(isInit!==!0){isInit=!0;for(a in e)c[a]=e[a];d(function(){b=$(f);var a=b.find("#sf-form"),d=a.find("#sf-frameworks");c.openDialog(b),i(a,d),h(a),j(b)})}},f="<div id='sf-wrapper'><div id='sf-header'><div id='sf-close'><a id='sf-close-link' href='#' class='simplemodal-close'>close</a></div><div id='sf-title'>Stack Fiddle It!</div></div><div id='sf-feedback'>Loading...</div><div id='sf-content'><form id='sf-form' method='post' action='http://jsfiddle.net/api/post/mootools/1.3.2/' target='_blank'><div id='sf-code' /><div class='sf-form-group'><label for='sf-frameworks'>Framework</label><select id='sf-frameworks'><option>Loading...</option></select></div><input type='submit' value='Fiddle It!' id='sf-submit' /></form></div></div>",g="<div class='sf-form-group'><label class='sf-code-label' /><textarea /><input type='radio' value='html' id='sf-code-html' /><label for='sf-code-html'>HTML</label><input type='radio' value='css' id='sf-code-css' /><label for='sf-code-css'>CSS</label><input type='radio' value='js' id='sf-code-js' /><label for='sf-code-js'>JS</label><input type='radio' value='none' id='sf-code-none' /><label for='sf-code-none'>None</label><div class='sf-show-container'><a href='#' class='sf-show-more sf-show'>More</a> | <a href='#' class='sf-show-less sf-show'>Less</a></div></div>",h=function(a){var d=function(){var a=5358066,b=c.stackUrl.split("/");for(var d=0;d<b.length;d++)if(b[d]=="questions"&&d+1<b.length){a=b[d+1];break}return a},e={js:["$","(","v",";"],html:["<","&"],css:[".","#"]},f=function(a,b){var c=$.trim(a.replace(/\/\*.+?\*\/|\/\/.*(?=[\n\r])/g,""))[0];for(lang in e)if($.inArray(c,e[lang])>-1){b.find("input[value='"+lang+"']").attr("checked",!0);break}};$.ajax({url:"http://api.stackoverflow.com/1.1/questions/"+d()+"?body=true",dataType:"jsonp",jsonp:"jsonp",success:function(a){var d=a.questions[0].body,e=$(d).find("code"),h=b.find("#sf-code"),i=b.find("#sf-feedback"),j=$("#question").find("code").map(function(){return codeParent=$(this).parent("pre"),codeParent.size()>0?codeParent.get():this});e.each(function(a){var b=$(g),d=b.find("textarea"),e=d.get(0),i=$(this);b.addClass("sf-code-group"),d.html(i.html()),b.find(".sf-code-label").html("Code Block "+(a+1)),b.find("input").each(function(){this.id=this.id+a,this.name="code"+a}),b.find("label").each(function(){var b=$(this);b.attr("for",b.attr("for")+a)}),h.append(b);var j=function(){d.height(0).css({resize:"none"}),d.height(d.get(0).scrollHeight).css({resize:"auto"})};if(!d.is(":hidden"))j();else var k=20,l=window.setInterval(function(){if(!d.is(":hidden")||k--==0)window.clearInterval(l),j()},50);f(d.html(),b),b.hover(function(){c.onMouseoverCode(!0,a)},function(){c.onMouseoutCode(!1,a)})}),i.text("Choose a content type for each code block")}})},i=function(a,b){var c="http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20html%20where%20url%3D%22http%3A%2F%2Fjsfiddle.net%22%20and%20xpath%3D%22%2F%2Fselect%5B%40id%3D'js_lib'%5D%22&diagnostics=true",d=["Three.js (edge)","YUI 2.8.0r4"];$.ajax({url:c,dataType:"jsonp",success:function(a){var c=$(a.results[0]),e=c.find("option"),f=c.find("optgroup");e.each(function(){var a=$(this),b=a.text().replace(/[A-Za-z ()\-]*/g,"");b===""||$.inArray(b,d)>-1?a.remove():a.val("/"+a.closest("optgroup").attr("label")+"/"+b+"/")}),f.each(function(){var a=$(this);a.children().size()===0&&a.remove()}),b.html(c.html())}})},j=function(a){var b=a.find("#sf-form"),d=b.find("#sf-frameworks"),e=b.find(".sf-code-group");$(".sf-show-more",a[0]).live("click",function(){var a=$(this).closest(".sf-form-group").find("textarea");return a.animate({height:"+=100px"},200),!1}),$(".sf-show-less",a[0]).live("click",function(){var a=$(this).closest(".sf-form-group").find("textarea");return a.animate({height:a.height()<=100?10:"-=100px"},200),!1}),a.find("#sf-close-link").click(c.closeDialog),b.submit(function(){var a={},e=b.find("textarea"),f=$("input:radio:checked",b);f.each(function(){var a=$(this);textarea=a.siblings("textarea"),a.val()=="none"?textarea.attr("disabled","disabled"):(textarea.removeAttr("disabled"),textarea.attr("name",a.val()))}),$.each(["html","css","js"],function(a,c){var d=e.filter("[name='"+this+"']");if(d.size()>1){var f="";d.each(function(){var a=$(this);f+=a.val(),a.attr("disabled","disabled")});var g=$("<input>",{type:"hidden",name:c,value:f});b.append(g)}}),b.attr("action","http://jsfiddle.net/api/post"+d.val()),setTimeout(c.closeDialog,300)})};return{init:e,openDialog:function(){c.openDialog(b),c.applyEventListenersOnOpen===!0&&j(b)}}}();
/**
 ...
 *
 * Mon Jan  2 23:51:06 PST 2012
 */
chrome.tabs.getSelected(null,function(a){var b=function(b,c){chrome.tabs.sendRequest(a.id,{hover:b,codeIndex:c})};StackFiddle.init({stackUrl:a.url,scripts:[],onMouseoverCode:b,onMouseoutCode:b,openDialog:function(a){$("#sf-container").empty().append(a)},closeDialog:function(){window.close()}})});